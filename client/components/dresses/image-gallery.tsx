  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-border bg-muted">
        <div
          key={selected}
          className="flex h-full items-center justify-center text-sm font-medium text-white animate-fade-in"
      ...
      <div className="flex gap-2">
        {images.map((img, i) => (
          <button
            ...
            className={cn(
              "relative h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg border-2 transition-all duration-300 sm:h-20 sm:w-20",
              selected === i
