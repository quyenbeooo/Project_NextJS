    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex flex-col justify-center flex-1 px-6 py-12 sm:px-12 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="mt-2 text-muted-foreground">Đăng nhập để thuê váy yêu thích của bạn.</p>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-background px-3 text-muted-foreground">Hoặc</span></div>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            Chưa có tài khoản?{" "}
            <Link href="/register" className="font-semibold text-foreground hover:underline">Đăng ký miễn phí</Link>
          </p>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 bg-muted items-center justify-center">
        <div className="text-center px-12">
          ...
          <h2 className="text-2xl font-bold mb-3">Thuê váy cao cấp</h2>
          <p className="text-muted-foreground">Tỏa sáng trong mọi dịp đặc biệt với bộ sưu tập váy đa dạng.</p>
        </div>
      </div>
    </div>
  );
